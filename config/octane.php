...
return [
    ...
    */
    ...
    | Tweak worker_num based on CPU cores (2–4x core count is a good start).
    |
    */
    'swoole' => [
        'server_options' => [
            ...
            'package_max_length' => 20 * 1024 * 1024, // max request size (20MB)
            'buffer_output_size' => 2 * 1024 * 1024, // output buffer size
            'socket_buffer_size' => 128 * 1024 * 1024, // TCP buffer
            'enable_coroutine' => true,            // enable coroutine runtime
            'open_http2_protocol' => true,         // enable HTTP/2
            'max_coroutine' => 100000,             // limit coroutines
